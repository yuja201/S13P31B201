...
INSERT OR IGNORE INTO domain_categories (id, name, description) VALUES
  (1, '이름/사람', '이름, 직업명 등 인물 관련 도메인'),
  (2, '주소/지역', '주소, 도시, 국가 등 지역 정보'),
  (3, '연락처/계정', '이메일, 전화번호, 사용자명 등'),
  (4, '회사/조직', '회사명, 부서명, 직종 등'),
  (5, '금융/결제', '계좌번호, 금액, 카드번호 등'),
  (6, '상품/상거래', '상품명, 카테고리, 가격 등'),
  (7, '차량/이동수단', '차량 브랜드, 모델, 번호 등'),
  (8, '날짜/시간', '과거/미래 날짜, 타임스탬프 등'),
  (9, '시스템/기술', 'UUID, 버전, 파일명 등'),
  (10, '데이터/숫자', '정수, 실수, 불리언 등'),
  (11, '텍스트/콘텐츠', '문장, 문단, 단어 등'),
  (12, '과학/교육', '과목명, 학교명, 단위 등'),
  (13, '색상/디자인', '색상명, RGB, HEX 코드 등'),
  (14, '엔터테인먼트/기타', '음악, 동물, 기타 랜덤 데이터');
`
